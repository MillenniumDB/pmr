...
public:
    ...
    virtual antlrcpp::Any visitPath(MDBParser::PathContext* ctx) override {
        ...
        PathSemantic semantic = PathSemantic::ANY;
        if (ctx->pathType() != nullptr) {
            ...
            if (semantic_str == "all") {
                semantic = PathSemantic::ALL;
            } else if (semantic_str == "all_count") {
                semantic = PathSemantic::ALL_COUNT;
            } else if (semantic_str == "all_fill_visited") {
                semantic = PathSemantic::ALL_FILL_VISITED;
            }
        }
